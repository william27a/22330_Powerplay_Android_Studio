...
@Autonomous(name = "Two Plus Parking Left")
public class TwoPlusParkingLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            robot.openClaw();
            sleep(1000);
            robot.move(-13.75, -13.75, -13.75, -13.75);
            arena.setRotationDegrees(180, 0.7);
            arena.setRotationDegrees(180, 0.1);
